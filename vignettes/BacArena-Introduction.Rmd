...
Here, by default we chose 100 times 100 as the grid size of the environment and a physical area of 0.25mm times 0.25mm. Next we want to put our created organism in its environment by

```{r}
arena <- addOrg(arena,bac,amount=1,x=50,y=50)
```
...
```{r}
arena <- Arena()
arena <- addOrg(arena,bac1,amount=1,x=25,y=50)
arena <- addOrg(arena,bac2,amount=1,x=75,y=50)
