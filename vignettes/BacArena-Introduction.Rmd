...
```{r}
g <- findFeeding3(eval, time = 10, mets = c("EX_but(e)", "EX_succ(e)") )
```
...
```{r}
plotSubUsage(eval, subs = c("EX_sucr(e)", "EX_amylose300(e)", "EX_amylopect900(e)", 
                                 "EX_cellb(e)", "EX_hdca(e)", "EX_ocdca(e)"))[[2]]
```

Whereby sucrose can be used by only by *B. longum* and fatty acids additionally by *B. producta*.