...
Metabolite concentrations were represented as $n \times m \in \mathbb{R}$ matrices. According to the requirements of the used genome-wide metabolic models certain metabolites were selected. In the present study these metabolites were: acetate, aketoglutarate, carbon dioxide, ethanol, formiate, fumarate, glucose, water, proton, lactate, oxygen, phosphate, pyruvate, succinate, hydrogen, methanol, methane, acetone, butyrate and butanol.

The entries of the metabolite matrices were initialized with a concentration of 70 nmol per grid cell. Additionally, in certain simulations the concentration was of selected metabolites set to 0 nmol to generate diverse metabolic phenotypes, such as anaerobic metabolisms.
