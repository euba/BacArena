if(!exists("barkeri_sbml", mode="list")) barkeri_sbml <- read.sbml("data/barkeri_iAF692.xml", "_b$") #_b$  regexpr for filtering external species (special handling necessary for equilibrium condition in fba)
